...
for name in glob.glob('/home/sam/my_project/vaudeville/variety_downloads/just_txt/truly_txt/variety*'):
        ...
        with open(name) as text_file:
                ...
                # venue pattern -- graps beginning of the line, with minimum 2 capitals, then all capitals and spaces (and paranthesis, untested) -- performer group grabs everything after that until the next double capitals. this is meant to be VERY grabby-- incorrect results will be weeded out later. 
...
with open('Vaudeville_Tour_Listings_Defense_practice_2.txt', 'w') as out_file:
